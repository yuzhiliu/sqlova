...
if __name__ == '__main__':
    ...
    parser.add_argument('--din', default='/home/ubuntu/data/WikiSQL-1.1/data', help='data directory')
    parser.add_argument('--dout', default='/home/ubuntu/data/wikisql_tok', help='output directory')
